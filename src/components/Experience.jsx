  ...
  return (
    ...
    >
      <div className="container mx-auto px-5 py-24">
        <h1 className="font-extrabold mb-12 text-6xl text-center animate-text-gradient bg-gradient-to-r from-[#b2a8fd] via-[#8678f9] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-transparent">
          EXPERIENCE
        </h1>
