    ...
    <>
      ...
      <div className="relative flex flex-col items-center justify-center h-screen">
        ...
        <div className="z-10 text-center px-4">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-extrabold mb-3">
            ETHAN LIU
          </h1>
        ...
        {/* Scroll down icon */}
        <motion.div
          className="absolute bottom-16 sm:bottom-10 flex flex-col items-center"
          initial={{ y: 0 }}
          animate={{ y: [0, 10, 0] }}
          transition={{
            duration: 1.5,
        ...
        >
          <div className="text-2xl sm:text-4xl text-purple-500 flex items-center">
            <LuMouse />
            <h3 className="text-sm sm:text-lg ml-2">scroll down</h3>
          </div>
        </motion.div>
